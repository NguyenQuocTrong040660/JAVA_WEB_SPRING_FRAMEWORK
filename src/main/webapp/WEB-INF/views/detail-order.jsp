	...
	<div class="content">
		...
		<div class="container">
			...
			<div class="container-fuild">
				...
				<h5>
					<b>Order Number--<c:forEach items="${orderDetails}" var="item"
							end="0">#BC${item.order.id}</c:forEach></b>
				</h5>
									...
									<table class="table" id="dataTable"  width="100%"
										...
										<thead style="">
											<h6 class="m-0 font-weight-bold text-lg text-danger">
												...
												Order Summary--
												<c:forEach items="${orderDetails}" var="item" end="0">#BC${item.order.id}</c:forEach>
											</h6>
										</thead>
										<tbody class="text-gray-900">
											<c:forEach items="${orderDetails}" var="item" end="0">
